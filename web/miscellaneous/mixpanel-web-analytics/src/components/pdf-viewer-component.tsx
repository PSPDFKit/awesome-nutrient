...
export default function PdfViewerComponent({
  ...
  const getDocumentInfoFromNutrient = useCallback(
    async (instance: any, currentFileName: string) => {
      try {
        const info = {
  ...
  const setupNutrientSDKEvents = useCallback((instance: any, docInfo: any) => {
    const baseEventData = {
      session_id: sessionId.current,
      ...docInfo,
    };
    ...
    try {
      ...
      // Zoom changes
      instance.addEventListener("viewState.zoom.change", (zoomLevel: number) => {
      ...
      // Annotation creation
      instance.addEventListener("annotations.create", (createdAnnotations: any) => {
      ...
      // Annotation updates
      instance.addEventListener("annotations.update", (updatedAnnotations: any) => {
      ...
      instance.addEventListener("annotationSelection.change", (selection: any) => {
      ...
      instance.addEventListener("annotations.press", (annotation: any) => {
      ...
      // Text selection
      instance.addEventListener("textSelection.change", (selection: any) => {
      ...
      // Form field updates
      instance.addEventListener("formFieldValues.update", (formFieldValues: any) => {
      ...
      // Form fields changes
      instance.addEventListener("formFields.change", (changes: any) => {
      ...
      instance.addEventListener("search.stateChange", (searchState: any) => {
      ...
      // Search term changes
      instance.addEventListener("search.termChange", (searchTerm: any) => {
      ...
      // Document changes
      instance.addEventListener("document.change", (changes: any) => {
      ...
      instance.addEventListener("document.saveStateChange", (saveState: any) => {
      ...
      // Page interactions
      instance.addEventListener("page.press", (pageInfo: any) => {
      ...
      // Bookmark changes
      instance.addEventListener("bookmarks.change", (bookmarks: any) => {
      ...
      // Comments changes
      instance.addEventListener("comments.change", (comments: any) => {
      ...
      instance.addEventListener("inkSignatures.create", (signature: any) => {
