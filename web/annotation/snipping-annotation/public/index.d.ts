import type * as _vanilla_extract_sprinkles from "@vanilla-extract/sprinkles";
...
import type {
  ...
  DOMAttributes as DOMAttributes$1,
  Dispatch,
  ElementType,
  FocusEvent as FocusEvent$1,
  FormEventHandler,
  ForwardedRef,
  ...
  Key as Key$1,
  KeyboardEvent as KeyboardEvent$1,
  ReactElement,
  ReactEventHandler,
  ReactHTML,
  ReactNode,
...
interface List<T> extends Collection$1.Indexed<T> {
  ...
  zip<U, V>(
    other: Collection$1<any, U>,
    other2: Collection$1<any, V>,
  ): List<[T, U, V]>;
...
interface Set$1<T> extends Collection$1.Set<T> {
   ...
   *     // Set [10,20]
   */
  map<M>(mapper: (value: T, key: T, iter: this) => M, context?: any): Set$1<M>;
...
declare function Seq<K, V>(
  collection: Collection$1.Keyed<K, V>,
): Seq.Keyed<K, V>;
 ...
 */
declare namespace Collection$1 {
  /**
  ...
  function isIndexed(
    maybeIndexed: any,
  ): maybeIndexed is Collection$1.Indexed<any>;
  ...
  function isAssociative(
    ...
    | Collection$1.Keyed<any, any>
    | Collection$1.Indexed<any>;
  ...
  export interface Keyed<K, V> extends Collection$1<K, V> {
    ...
    concat<KC, VC>(
      ...collections: Array<Iterable<[KC, VC]>>
    ): Collection$1.Keyed<K | KC, V | VC>;
    concat<C>(
      ...collections: Array<{ [key: string]: C }>
    ): Collection$1.Keyed<K | string, V | C>;
 ...
 * use the `new` keyword during construction.
 */
declare function Collection$1<I extends Collection$1<any, any>>(
  collection: I,
): I;
...
type SidebarOptions<
  T extends AnnotationsSidebarOptions | LayersSidebarOptions,
> = T extends AnnotationsSidebarOptions
  ? {
...
interface IViewState {
  ...
  sidebarOptions: SidebarOptions<
    AnnotationsSidebarOptions | LayersSidebarOptions
  >;
...
interface CollectionStateBase<
  T,
  C extends Collection<Node$1<T>> = Collection<Node$1<T>>,
...
interface AriaSelectProps<T>
  extends SelectProps$1<T>,
    DOMProps,
    AriaLabelingProps,
    FocusableDOMProps {
  /**
...
interface SelectStateOptions<T>
  extends Omit<SelectProps$1<T>, "children">,
...
interface DroppableCollectionStateOptions
  extends Omit<DroppableCollectionProps, "onDropMove" | "onDropActivate"> {
  /** A collection of items. */
  collection: Collection<Node$1<unknown>>;
  /** An interface for reading and updating multiple selection state. */
  selectionManager: MultipleSelectionManager;
...
interface AriaMenuProps<T>
  extends MenuProps$1<T>,
    DOMProps,
    AriaLabelingProps {}
...
interface SliderProps$1<T = number | number[]>
...
interface AriaSliderProps<T = number | number[]>
  extends SliderProps$1<T>,
    DOMProps,
    AriaLabelingProps {}
...
interface LinkButtonProps<T extends ElementType = "button">
...
interface AriaButtonProps<T extends ElementType = "button">
  extends ButtonProps,
    LinkButtonProps<T>,
    AriaBaseButtonProps {}
interface AriaToggleButtonProps<T extends ElementType = "button">
  extends ToggleButtonProps$1,
    AriaBaseButtonProps,
 ...
 * @param options - Formatting options.
 */
declare function useNumberFormatter(
 ...
 */
declare function useOverlayTrigger(
...
declare const createLayerSprinkles: (layer: string) => ((
  props: {
    paddingBlockStart?:
      | (
          | "none"
      ...
      | _vanilla_extract_sprinkles.ResponsiveArray<
          1 | 2 | 3,
          | "none"
          | "xs"
          | "sm"
    ...
    color?:
      ...
      | "support.error.subtler"
      | "support.error.subtle"
      | "support.error.medium"
      | "support.error.strong"
      | "support.success.subtler"
      | "support.success.subtle"
      | "support.success.medium"
      | "support.success.strong"
      | "support.warning.subtler"
      | "support.warning.subtle"
      | "support.warning.medium"
      | "support.warning.strong"
      | "support.info.subtler"
      | "support.info.subtle"
      | "support.info.medium"
      | "support.info.strong"
      | "focused.primary"
    ...
    display?:
      ...
      | _vanilla_extract_sprinkles.ResponsiveArray<
          1 | 2 | 3,
          "none" | "flex" | "grid" | "block" | "inline-flex" | null
        >;
    flexDirection?:
      | (
          | "column"
      ...
      | _vanilla_extract_sprinkles.ResponsiveArray<
          1 | 2 | 3,
          "column" | "column-reverse" | "row" | "row-reverse" | null
        >;
    alignItems?:
      | (
          | "stretch"
      ...
      | _vanilla_extract_sprinkles.ResponsiveArray<
          1 | 2 | 3,
          "stretch" | "center" | "flex-end" | "flex-start" | null
        >;
    alignSelf?:
      | (
          | "stretch"
    ...
    flex?:
      ...
      | _vanilla_extract_sprinkles.ResponsiveArray<1 | 2 | 3, number | null>;
    justifyContent?:
      | (
          | "space-between"
          | "stretch"
...
declare type TargetParam<Param> = Pick<
  Param,
...
declare type EventListener<Param, Target> = (
  e: OnEvent$1<Param, Target>,
) => any;
...
> {
  private _events;
  on<Name extends keyof Events, Param = Events[Name]>(
    eventName: Name,
    listener: EventListener<Param, this>,
  ): this;
  on(events: EventHash<Events, this>): this;
  off<Name extends keyof Events, Param = Events[Name]>(
    eventName?: Name,
    listener?: EventListener<Param, this>,
  ): this;
  off(events: EventHash<Events, this>): this;
  once<Name extends keyof Events & string, Param = Events[Name]>(
    eventName: Name,
    listener?: EventListener<Param, this>,
  ): Promise<OnEvent$1<Param, this>>;
  emit<Name extends keyof Events, Param = Events[Name]>(
  ...
  trigger<Name extends keyof Events, Param = Events[Name]>(
 ...
 */
interface MoveableDefaultOptions
 ...
 * @typedef
 */
declare type MoveableRefType<T extends Element = HTMLElement | SVGElement> =
  | string
  | (() => T)
  | MoveableRefObject<T>
  | T
...
interface OnEvent {
   ...
   */
  currentTarget: MoveableManagerInterface<
    Record<string, any>,
    Record<string, any>
  >;
  /**
...
type DragAndDropProps = Omit<
  ...
  | "onItemDrop"
> &
  Partial<Pick<DraggableCollectionStateOptions, "getItems">> & {
    /**
...
interface ListBoxProps
  extends StylingProps,
    Omit<
      AriaListBoxProps<ListItem> & AriaListBoxOptions<ListItem>,
      "children" | "linkBehavior" | "isVirtualized" | "keyboardDelegate"
    >,
    Omit<
      DragAndDropProps,
      "preview" | "enableReorder" | "orientation" | "layout"
    >,
    Partial<
      Pick<DragAndDropProps, "enableReorder" | "orientation" | "layout">
    > {
  /**
  ...
  renderDropIndicator?: (
    ...
    ref: React__default.RefObject<HTMLLIElement>,
  ) => React__default.ReactNode;
  /**
...
declare const ListBox: React__default.ForwardRefExoticComponent<
  ListBoxProps & React__default.RefAttributes<HTMLUListElement>
>;

interface ActionButtonSharedProps
  extends Omit<
      AriaButtonProps<"button" | "div">,
      "rel" | "href" | "target" | "children"
    >,
    StylingProps {}
...
declare const ActionButton: React__default.ForwardRefExoticComponent<
  ActionButtonProps & React__default.RefAttributes<HTMLButtonElement>
>;
...
declare const DomNodeRenderer: React__default.ForwardRefExoticComponent<
  DomNodeRendererProps & React__default.RefAttributes<HTMLDivElement>
>;

interface SliderProps
  extends Omit<
      AriaSliderProps<number> & SliderStateOptions<number>,
      "orientation" | "numberFormatter"
    >,
    StylingProps {
  /**
...
declare const Slider: React__default.ForwardRefExoticComponent<
  SliderProps & React__default.RefAttributes<HTMLDivElement>
>;
...
declare const Switch: React__default.ForwardRefExoticComponent<
  SwitchProps & React__default.RefAttributes<HTMLLabelElement>
>;
...
declare const SearchInput: React__default.ForwardRefExoticComponent<
  SearchInputProps & React__default.RefAttributes<HTMLDivElement>
>;
...
declare const ThemeProvider: React__default.ForwardRefExoticComponent<
  ThemeProviderProps & React__default.RefAttributes<HTMLDivElement>
>;
...
interface PopoverProps extends OverlayTriggerProps$1, OverlayTriggerProps_ {
  ...
  children:
    | React__default.ReactNode
    | ((state: OverlayTriggerState) => React__default.ReactNode);
}
...
>;
interface MenuProps
  extends MenuPopoverProps,
    MenuTriggerProps,
    Omit<AriaMenuProps<MenuItem>, "children">,
...
declare const Menu: React__default.ForwardRefExoticComponent<
  MenuProps & React__default.RefAttributes<HTMLUListElement>
>;
...
declare const Link: React__default.ForwardRefExoticComponent<
  LinkProps & React__default.RefAttributes<HTMLElement>
>;
...
declare const FileUpload: React__default.ForwardRefExoticComponent<
  FileUploadProps & React__default.RefAttributes<HTMLLabelElement>
>;
...
declare const ProgressBar: React__default.ForwardRefExoticComponent<
  ProgressBarProps & React__default.RefAttributes<HTMLDivElement>
>;
...
interface TextInputProps
  extends Omit<
      AriaTextFieldProps,
      "validationState" | "isInvalid" | "description" | "errorMessage"
    >,
    StylingProps,
    InputMessage {
...
declare const TextInput: React__default.ForwardRefExoticComponent<
  TextInputProps & React__default.RefAttributes<HTMLInputElement>
>;

interface ReactionProps
  extends Omit<
      AriaSwitchProps & ToggleProps,
      | "validationState"
      | "isRequired"
      | "children"
      | "isInvalid"
...
declare const Reaction: React__default.ForwardRefExoticComponent<
  ReactionProps & React__default.RefAttributes<HTMLLabelElement>
>;
...
interface TooltipProps
  extends TooltipTriggerProps,
    ...
    Omit<
      AriaPositionProps,
      "overlayRef" | "targetRef" | "maxHeight" | "isOpen" | "arrowSize"
    > {
...
declare const ProgressSpinner: React__default.ForwardRefExoticComponent<
  ProgressSpinnerProps & React__default.RefAttributes<HTMLDivElement>
>;
...
declare const ActionIconButton: React__default.ForwardRefExoticComponent<
  ActionIconButtonProps & React__default.RefAttributes<HTMLButtonElement>
>;
...
declare const ToggleButton: React__default.ForwardRefExoticComponent<
  ToggleButtonProps & React__default.RefAttributes<HTMLButtonElement>
>;

interface CheckboxProps
  extends Omit<
      AriaCheckboxProps,
      "children" | "validationBehavior" | "validationState" | "validate"
    >,
    StylingProps {
...
declare const Checkbox: React__default.ForwardRefExoticComponent<
  CheckboxProps & React__default.RefAttributes<HTMLLabelElement>
>;
...
interface PaginationProps
  extends Omit<AriaNumberFieldProps, Excluded>,
    Omit<NumberFieldStateOptions, Excluded>,
    StylingProps {
  /** The largest value allowed for the input. */
  maxValue: number;
...
declare const Pagination: React__default.ForwardRefExoticComponent<
  PaginationProps & React__default.RefAttributes<HTMLDivElement>
>;
...
interface TagGroupProps
  extends StylingProps,
    Omit<AriaTagGroupProps<Item>, "children" | "errorMessage" | "description">,
    Omit<ListProps<Item>, "children" | "collection" | "filter"> {
  /**
...
declare const TagGroup: React__default.ForwardRefExoticComponent<
  TagGroupProps & React__default.RefAttributes<HTMLDivElement>
>;
...
interface AccordionItemProps extends StylingProps {
  ...
  actions?: Omit<
    ...
    "size" | "variant" | "excludeFromTabOrder"
  >[];
  /**
...
declare const Accordion: React__default.ForwardRefExoticComponent<
  AccordionProps & React__default.RefAttributes<HTMLDivElement>
>;

declare const AccordionItem: React__default.ForwardRefExoticComponent<
  AccordionItemProps & React__default.RefAttributes<HTMLHeadingElement>
>;

interface SelectProps
  extends Omit<
      AriaSelectOptions<ListItem> &
        SelectStateOptions<ListItem> &
        PopoverContentProps,
      | "validationState"
      | "items"
      | "children"
      ...
      | "keyboardDelegate"
    >,
    Pick<ListBoxProps, "items" | "showSelectedIcon">,
    StylingProps {
  /**
   * The position of the label.
   *
...
declare const Select: React__default.ForwardRefExoticComponent<
  SelectProps & React__default.RefAttributes<HTMLDivElement>
>;
...
type ItemProps = React__default.ComponentProps<typeof Item$1> &
  StylingProps & {
    key?: Key$1;
    icon?: React__default.FC<SVGRProps>;
    value?: string;
...
type TabsProps = Omit<
  StylingProps & AriaTabListProps<ItemProps>,
  | "orientation"
  | "children"
  | "items"
  | "selectedKey"
...
declare const InlineAlert: React__default.ForwardRefExoticComponent<
  InlineAlertProps & React__default.RefAttributes<HTMLDivElement>
>;
...
interface NumberInputProps
  extends StylingProps,
    Omit<
      ...
      "validationState" | "isRequired" | "validate" | "validationBehavior"
    > {
  /**
   * The position of the label relative to the input.
   *
...
declare const NumberInput: React__default.ForwardRefExoticComponent<
  NumberInputProps & React__default.RefAttributes<HTMLDivElement>
>;
...
declare const Dialog: React__default.ForwardRefExoticComponent<
  DialogProps & React__default.RefAttributes<HTMLDivElement>
>;

declare const DialogTitle: React__default.ForwardRefExoticComponent<
  DialogTitleProps & React__default.RefAttributes<HTMLDivElement>
>;
...
interface ColorInputProps
  extends OverlayTriggerProps$1,
    StylingProps,
    Pick<
      ColorFieldProps,
      "onChange" | "defaultValue" | "value" | "label" | "isDisabled"
    >,
    Pick<AriaLabelingProps, "aria-label">,
    Pick<
      PopoverContentProps,
      | "isNonModal"
      | "placement"
...
declare const ColorInput: React__default.ForwardRefExoticComponent<
  ColorInputProps & React__default.RefAttributes<HTMLDivElement>
>;
...
declare const IconColorInputButton: React__default.ForwardRefExoticComponent<
  Omit<ColorInputButtonProps, "children" | "labelPosition"> & {
    icon: React__default.FC<IconProps>;
...
declare const FreehandCanvas: React__default.ForwardRefExoticComponent<
  FreehandCanvasProps & React__default.RefAttributes<HTMLDivElement>
>;

type TextProps<T extends keyof React__default.JSX.IntrinsicElements = "span"> =
  StylingProps &
...
declare const Text$1: React__default.ForwardRefExoticComponent<
  Pick<
    TextProps,
    | "children"
    | "autoFocus"
...
interface TransformProps {
  ...
  onDoubleClick?: (
    e: React__default.MouseEvent<HTMLDivElement, MouseEvent>,
  ) => void;
  ...
  scrollableAncestor?:
    | React__default.RefObject<HTMLElement>
    | string
    | HTMLElement;
  /**
   * Whether to prevent bubbling of events like mousedown, touchstart, etc.
...
declare const Transform: React__default.ForwardRefExoticComponent<
  TransformProps & React__default.RefAttributes<HTMLDivElement>
>;

interface ImageDropZoneProps
  extends Omit<SharedFileUploadProps, "label" | "variant">,
    Omit<
      DropOptions,
      "ref" | "getDropOperation" | "hasDropButton" | "getDropOperationForPoint"
    >,
    Omit<ClipboardProps, "getItems" | "onCut" | "onCopy">,
    Pick<
      FreehandCanvasProps,
      "footerClassName" | "footerStyle" | "placeholder" | "clearLabel"
    >,
    AriaLabelingProps {
  /**
...
declare const ImageDropZone: React__default.ForwardRefExoticComponent<
  ImageDropZoneProps & React__default.RefAttributes<HTMLDivElement>
>;
...
declare const Preview: React__default.ForwardRefExoticComponent<
  PreviewProps & React__default.RefAttributes<HTMLDivElement>
>;
...
declare const Group: React__default.ForwardRefExoticComponent<
  GroupProps & React__default.RefAttributes<HTMLDivElement>
>;

type SprinkleProps = Parameters<Sprinkles>[0];
interface BoxProps
  extends Pick<StylingProps, "data-block-id">,
    Omit<React__default.ComponentPropsWithoutRef<"div">, "color">,
    SprinkleProps {
  /**
...
interface ColorPresetInlineInputProps
  extends Omit<RadioGroupProps, "items" | "disabledValues"> {
  items: ColorPreset$1[];
}

declare const ColorPresetInlineInput: React__default.ForwardRefExoticComponent<
  ColorPresetInlineInputProps & React__default.RefAttributes<HTMLDivElement>
>;
...
declare const Toolbar: React__default.ForwardRefExoticComponent<
  ToolbarProps & React__default.RefAttributes<HTMLDivElement>
>;

interface ToggleIconButtonProps
  extends StylingProps,
    Omit<ToggleProps, "children">,
    Omit<ToggleButtonProps, "size" | "iconStart" | "label"> {
  /**
...
declare const ToggleIconButton: React__default.ForwardRefExoticComponent<
  ToggleIconButtonProps & React__default.RefAttributes<HTMLButtonElement>
>;
...
declare const Editor: React__default.ForwardRefExoticComponent<
  EditorProps & React__default.RefAttributes<HTMLDivElement>
>;

interface ScrollControlButtonProps
  extends StylingProps,
    Pick<ActionButtonProps, "label"> {
  /**
...
declare const ScrollControlButton: React__default.ForwardRefExoticComponent<
  ScrollControlButtonProps & React__default.RefAttributes<HTMLButtonElement>
>;
...
declare const AlertDialog: React__default.ForwardRefExoticComponent<
  AlertDialogProps & React__default.RefAttributes<HTMLDivElement>
>;
...
declare const Markdown: React__default.ForwardRefExoticComponent<
  MarkdownProps & React__default.RefAttributes<HTMLDivElement>
>;
...
declare const Drawer: React__default.ForwardRefExoticComponent<
  DrawerProps & React__default.RefAttributes<HTMLDivElement>
>;
...
declare const AudioPlayer: React__default.ForwardRefExoticComponent<
  AudioPlayerProps & React__default.RefAttributes<HTMLDivElement>
>;
 ...
 */
declare function useI18n<T extends Record<string, string>>(
  messages?: Record<string, T>,
): I18nResult<T>;
interface I18nResult<T extends LocalizedStrings[keyof LocalizedStrings]> {
  formatMessage: (
    id: keyof T | MessageDescriptor<T>,
    values?: Record<string, any>,
  ) => string;
  locale: Locale;
}
interface MessageDescriptor<
  T extends LocalizedStrings[keyof LocalizedStrings],
> {
  id: keyof T;
  defaultMessage?: string;
}
...
type Core_I18nResult<T extends LocalizedStrings[keyof LocalizedStrings]> =
  I18nResult<T>;
...
type Core_TextProps<
  T extends keyof React__default.JSX.IntrinsicElements = "span",
> = TextProps<T>;
...
declare namespace Core {
  export {
    Core_Accordion as Accordion,
    Core_AccordionItem as AccordionItem,
    type Core_AccordionItemProps as AccordionItemProps,
    type Core_AccordionProps as AccordionProps,
    Core_ActionButton as ActionButton,
    type Core_ActionButtonProps as ActionButtonProps,
    Core_ActionIconButton as ActionIconButton,
    type Core_ActionIconButtonProps as ActionIconButtonProps,
    Core_AlertDialog as AlertDialog,
    type Core_AlertDialogProps as AlertDialogProps,
    Core_AudioPlayer as AudioPlayer,
    type Core_AudioPlayerProps as AudioPlayerProps,
    Core_Avatar as Avatar,
    type Core_AvatarProps as AvatarProps,
    type Core_BlockProps as BlockProps,
    Core_Box as Box,
    type Core_BoxProps as BoxProps,
    Core_Checkbox as Checkbox,
    type Core_CheckboxProps as CheckboxProps,
    Core_ColorInput as ColorInput,
    type Core_ColorInputProps as ColorInputProps,
    type ColorPreset$1 as ColorPreset,
    Core_ColorPresetInlineInput as ColorPresetInlineInput,
    type Core_ColorPresetInlineInputProps as ColorPresetInlineInputProps,
    Core_ColorSwatch as ColorSwatch,
    type Core_ColorSwatchProps as ColorSwatchProps,
    Core_DateFormat as DateFormat,
    type Core_DateFormatProps as DateFormatProps,
    Core_Dialog as Dialog,
    type Core_DialogProps as DialogProps,
    Core_DialogTitle as DialogTitle,
    type Core_DialogTitleProps as DialogTitleProps,
    Core_DomNodeRenderer as DomNodeRenderer,
    type Core_DomNodeRendererProps as DomNodeRendererProps,
    Core_Drawer as Drawer,
    type Core_DrawerProps as DrawerProps,
    Core_Editor as Editor,
    type Core_EditorProps as EditorProps,
    Core_FileUpload as FileUpload,
    type Core_FileUploadProps as FileUploadProps,
    Core_FreehandCanvas as FreehandCanvas,
    type Core_FreehandCanvasProps as FreehandCanvasProps,
    Core_Group as Group,
    type Core_GroupProps as GroupProps,
    Core_I18nProvider as I18nProvider,
    type I18nProviderProps$1 as I18nProviderProps,
    type Core_I18nResult as I18nResult,
    Core_IconColorInputButton as IconColorInputButton,
    Core_ImageDropZone as ImageDropZone,
    type Core_ImageDropZoneProps as ImageDropZoneProps,
    Core_InlineAlert as InlineAlert,
    type Core_InlineAlertProps as InlineAlertProps,
    Core_Link as Link,
    type Core_LinkProps as LinkProps,
    Core_ListBox as ListBox,
    type Core_ListBoxProps as ListBoxProps,
    type Core_ListOption as ListOption,
    Core_Markdown as Markdown,
    type Core_MarkdownProps as MarkdownProps,
    Core_Menu as Menu,
    type Core_MenuItem as MenuItem,
    type Core_MenuProps as MenuProps,
    type Core_MessageDescriptor as MessageDescriptor,
    Core_MessageFormat as MessageFormat,
    type Core_MessageFormatProps as MessageFormatProps,
    Core_Modal as Modal,
    Core_ModalClose as ModalClose,
    Core_ModalContent as ModalContent,
    type Core_ModalContentProps as ModalContentProps,
    type Core_ModalProps as ModalProps,
    Core_ModalTrigger as ModalTrigger,
    Core_NumberFormat as NumberFormat,
    type Core_NumberFormatProps as NumberFormatProps,
    Core_NumberInput as NumberInput,
    type Core_NumberInputProps as NumberInputProps,
    Core_Pagination as Pagination,
    type Core_PaginationProps as PaginationProps,
    Core_Popover as Popover,
    Core_PopoverContent as PopoverContent,
    type Core_PopoverContentProps as PopoverContentProps,
    type Core_PopoverProps as PopoverProps,
    Core_PopoverTrigger as PopoverTrigger,
    type Core_PopoverTriggerProps as PopoverTriggerProps,
    Core_Portal as Portal,
    type Core_PortalProps as PortalProps,
    Core_Preview as Preview,
    type Core_PreviewProps as PreviewProps,
    Core_ProgressBar as ProgressBar,
    type Core_ProgressBarProps as ProgressBarProps,
    Core_ProgressSpinner as ProgressSpinner,
    type Core_ProgressSpinnerProps as ProgressSpinnerProps,
    Core_RadioGroup as RadioGroup,
    type Core_RadioGroupProps as RadioGroupProps,
    Core_Reaction as Reaction,
    type Core_ReactionProps as ReactionProps,
    Core_ScrollControlButton as ScrollControlButton,
    type Core_ScrollControlButtonProps as ScrollControlButtonProps,
    Core_SearchInput as SearchInput,
    type Core_SearchInputProps as SearchInputProps,
    Core_Select as Select,
    type Core_SelectProps as SelectProps,
    Core_Separator as Separator,
    type Core_SeparatorProps as SeparatorProps,
    Core_Slider as Slider,
    type Core_SliderProps as SliderProps,
    type Core_StylingProps as StylingProps,
    Core_Switch as Switch,
    type Core_SwitchProps as SwitchProps,
    Core_TabItem as TabItem,
    type Core_TabItemProps as TabItemProps,
    Core_Tabs as Tabs,
    type Core_TabsProps as TabsProps,
    Core_TagGroup as TagGroup,
    type Core_TagGroupProps as TagGroupProps,
    Text$1 as Text,
    Core_TextInput as TextInput,
    type Core_TextInputProps as TextInputProps,
    type Core_TextProps as TextProps,
    Core_ThemeProvider as ThemeProvider,
    type Core_ThemeProviderProps as ThemeProviderProps,
    Core_ToggleButton as ToggleButton,
    type Core_ToggleButtonProps as ToggleButtonProps,
    Core_ToggleIconButton as ToggleIconButton,
    type Core_ToggleIconButtonProps as ToggleIconButtonProps,
    Core_Toolbar as Toolbar,
    type Core_ToolbarProps as ToolbarProps,
    Core_Tooltip as Tooltip,
    type Core_TooltipProps as TooltipProps,
    Core_Transform as Transform,
    type Core_TransformProps as TransformProps,
    Core_defineMessages as defineMessages,
    Core_useCollator as useCollator,
    Core_useDateFormatter as useDateFormatter,
    Core_useDevice as useDevice,
    Core_useI18n as useI18n,
    Core_useImage as useImage,
    Core_useIntersectionObserver as useIntersectionObserver,
    Core_useIsFirstRender as useIsFirstRender,
    Core_useLocalStorage as useLocalStorage,
    Core_useMutationObserver as useMutationObserver,
    Core_useNumberFormatter as useNumberFormatter,
    Core_useResizeObserver as useResizeObserver,
    Core_useTextSelection as useTextSelection,
    Core_useUndoRedo as useUndoRedo,
    Core_useUserPreferences as useUserPreferences,
  };
}
...
type Child =
  ...
  | string
  | number
  | ((...args: Any$1[]) => React__default.ReactElement);
type Props<T extends AnyComponent> = Omit<
  React__default.ComponentPropsWithRef<T>,
  "children"
> & {
 ...
 * @param children
 */
declare function createBlock<const T extends keyof React__default.ReactHTML>(
  component: T,
  props?: Omit<React__default.ComponentPropsWithRef<T>, "children"> & BlockId,
  ...children: Child[]
): Block<T>;
declare function createBlock<
  T extends React__default.ForwardRefExoticComponent<Any>,
>(
  component: T,
  props?: Omit<React__default.ComponentPropsWithRef<T>, "children"> & BlockId,
  ...children: Child[]
): Block<T>;
declare function createBlock<T extends (...args: Any[]) => Any>(
  component: T,
  props?: Omit<Parameters<T>[0], "children"> & BlockId,
  ...children: Child[]
): Block<T>;
...
interface BaseChildrenArgs<T = Record<string, never>> extends RecipeResult<T> {
...
interface BaseRecipeProps<State extends IRecord, ChildArgs extends IRecord> {
  /**
...
interface SignaturesListProps
  extends SharedProps$4,
    BaseRecipeProps<IRecord, ChildrenArgs$4> {}
...
interface SharedProps$3 extends StylingProps {
  ...
  onAdd: (
    state: Omit<InternalState$2, "image" | "text" | "ink"> & {
      canvasSize:
        | {
            height: number;
            width: number;
...
interface ChildrenArgs$3
  extends SharedProps$3,
    BaseChildrenArgs<InternalState$2> {}
interface CreateSignatureProps
  extends SharedProps$3,
    BaseRecipeProps<InternalState$2, ChildrenArgs$3> {}
...
interface CreateStampProps
  extends SharedProps$2,
    BaseRecipeProps<InternalState$1, ChildrenArgs$2> {}
...
interface StampsListProps
  extends SharedProps$1,
    BaseRecipeProps<InternalState, ChildrenArgs$1> {}

declare const Recipes: {
  readonly SignaturesList: React.ForwardRefExoticComponent<
    SignaturesListProps & React.RefAttributes<HTMLDivElement>
  >;
  readonly CreateSignature: React.ForwardRefExoticComponent<
    CreateSignatureProps & React.RefAttributes<HTMLDivElement>
  >;
  readonly StampsList: React.ForwardRefExoticComponent<
    StampsListProps & React.RefAttributes<HTMLDivElement>
  >;
  readonly CreateStamp: React.ForwardRefExoticComponent<
    CreateStampProps & React.RefAttributes<HTMLDivElement>
  >;
};
type InterfacesType = {
...
type ElectronicSignatureDefaultTextCallback = () =>
  | string
  | undefined
  | undefined;
...
export {
  ...
  List,
  ListBoxFormField,
  type MentionableUser$1 as MentionableUser,
  NamedAction,
  NoteAnnotation,
